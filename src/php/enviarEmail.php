...
$mailer->From = 'sitealldrop@alldrop.com.br'; //Obrigatório ser a mesma caixa postal configurada no remetente do SMTP
$mailer->AddAddress('alldrop@alldrop.com.br','Alldrop');
//Destinatários
